...
/**
 * Created by Awanish Raj on 26/05/15.
 */
...
public class ConnectivityUtil {
     ...
     * @return
     */
    public static boolean isNotConnectedToWifi(Context context) {
        NetworkInfo info = ConnectivityUtil.getNetworkInfo(context);
        return (info == null || !info.isConnected() || info.getType() != ConnectivityManager.TYPE_WIFI);
    }

    public static boolean isWifiConnectedTo(Context context, String ssid) {
        ConnectivityManager connManager = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo networkInfo = connManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
        Slog.e("CONUTIL", "Connected!" + networkInfo.toString());
